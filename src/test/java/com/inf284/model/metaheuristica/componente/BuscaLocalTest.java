...
public class BuscaLocalTest {
    ...
    @Test
    public void testarMetodoDoisOpt() {
        ...
        BuscaLocal buscaLocal = new BuscaLocal(instancia);
        solucao = buscaLocal.bestImprovement_2_Opt(solucao);
    ...
    @Test
    public void testarMetodoDoisOptParaTodasAsInstancias() {
